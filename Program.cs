...
namespace Calculator
{
    class Program
    {
        ...
        static void Subtracao()
        {
            ...
            Console.WriteLine($"O resultado de subtração dos múmeros é: {resultado}");
        ...
        static void Multiplicacao()
        {
            ...
            Console.WriteLine($"O resultado da multiplicação entre os dois números é: {resultado}");
